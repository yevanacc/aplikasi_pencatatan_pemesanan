                            ...
                            <div class="card-body" style="display: flex; flex-direction: column;">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="kodePembayaran"
                                        ...
                                        name="kode_pembayaran" required readonly>
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="text" class="form-control" name="no_hp" id="noHp" required
                                        readonly>
                                </div>
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="date" class="form-control" name="tanggal_bayar" id="tanggalBayar"
                                        min="{{ date('Y-m-d') }}" required>
                                </div>

                                <div class="mb-1">
                                    <label for="total_harga" class="form-label">Total Harga</label>
                                    <input type="text" class="form-control" name="total_harga" id="totalHarga" required
                                        readonly>
                                </div>

                                <div class="mb-1">
                                    <label for="uang_muka" class="form-label">Uang Muka</label>
                                    <input type="text" class="form-control" name="uang_muka" id="uangMuka" required
                                        readonly>
                                </div>

                                <div class="mb-1">
                                    <label for="sisa_pembayaran" class="form-label">Sisa Pembayaran</label>
                                    <input type="text" class="form-control" name="sisa_pembayaran" id="sisaPembayaran"
                                        required readonly>
                                </div>
                                ...
                                <button type="submit" class="btn btn-success btn-primary shadow-sm bg-green mb-2">Tambah
                                    Pembayaran</button>
                                <a href="{{ route('pembayaranPemilik.index') }}"
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('paymentForm').addEventListener('submit', function() {
            ...
            document.getElementById('totalHarga').value = removeThousandSeparators(document
                .getElementById('totalHarga').value);
            document.getElementById('uangMuka').value = removeThousandSeparators(document
                .getElementById('uangMuka').value);
            document.getElementById('sisaPembayaran').value = removeThousandSeparators(document
                .getElementById('sisaPembayaran').value);
        });
    });

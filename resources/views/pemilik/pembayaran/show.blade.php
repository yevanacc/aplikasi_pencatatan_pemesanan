        ...
        <div class="card shadow m-4">
            <div class="card-header py-3">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-0">
                    <a href="{{ route('pembayaranPemilik.create') }}" class="btn btn-auto btn-primary shadow-sm">
                            ...
                            <tbody>
                                @forelse ($pembayarans as $index => $pembayaran)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('pembayaranPemilik.edit', $pembayaran->id) }}"
                                                class="btn btn-primary mb-2">Edit</a>
                                            <form action="{{ route('pembayaranPemilik.destroy', $pembayaran->id) }}"

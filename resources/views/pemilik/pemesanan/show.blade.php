        ...
        <div class="card shadow m-4">
            <div class="card-header py-3">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-0">
                    <a href="{{ route('pemesananPemilik.create') }}" class="btn btn-auto  btn-primary shadow-sm">
                            ...
                            <tbody>
                                @forelse ($pemesanans as $index => $pemesanan)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('pemesananPemilik.edit', $pemesanan->id) }}"
                                                class="btn btn-primary mb-2">Edit</a>
                                            <form action="{{ route('pemesananPemilik.destroy', $pemesanan->id) }}" method="POST"

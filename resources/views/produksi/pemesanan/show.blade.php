                                ...
                                @forelse ($pemesanans as $index => $pemesanan)
                                    @foreach ($pemesanan->pemesananDetails as $detail)
                                        <tr>
                                            ...
                                            <td>{{ $detail->ukuran }}</td> <!-- Pastikan $detail tidak null -->
                                            <td>{{ $detail->panjang }}</td> <!-- Tambahkan baris ini -->
                                            <td>{{ $detail->lebar }}</td> <!-- Tambahkan baris ini -->
                                            <td>{{ $detail->jumlah_banner }}</td> <!-- Tambahkan baris ini -->
                                            ...
                                            <td>
                                                <a href="{{ route('pemesananProduksi.edit', $pemesanan->id) }}"
                                                    class="btn btn-primary mb-2">Edit</a>
                                                {{-- <form action="{{ route('pemesananProduksi.destroy', $pemesanan->id) }}"

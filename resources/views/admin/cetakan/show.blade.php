    ...
    <div class="card shadow m-4 col-9 mx-auto">
        <div class="card-header py-3">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-0">
                <a href="{{ route('jenisCetakan.create') }}" class="btn btn-auto  btn-primary shadow-sm">
                             ...
                             @forelse ($cetakans as $index => $cetakan)
                                     <tr>
                                        <td>{{ $index + 1 }}</td>
                                         ...
                                         <td>
                                            <a href="{{ route('jenisCetakan.edit', $cetakan->id) }}" class="btn btn-primary mb-2">Edit</a>
                                            <form action="{{ route('jenisCetakan.destroy', $cetakan->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
